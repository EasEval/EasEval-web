/* this is the main javascript file assosiacted with the EasEval web app. Its functions contain logic for all the dynamic stuff that needs to happen. It delegates work to 1) parseQuery, which handles the backend database connection. 2) cookieHandler that takes cares of the cookie(s), as well as 3) languageHandler that contains all the language-data and logic related to changing language */
...
function setupGraphics() {
    $(function() {
        ...
        $("#sliderRate").slider({value:50});
        $("#sliderTime").slider({value:50});
...
$(document).ready(function() {
   ...
   $("#sendButton").click(function(event) { 
    ...
    // icons for question 3 have eventHandlers for mouseovers, showing description
    $("#lectureIcon").mouseover(function(){$("#lectureLabel p").show()}).mouseout(function(){$("#lectureLabel p").hide()});
    $("#internetIcon").mouseover(function(){$("#internetLabel p").show()}).mouseout(function(){$("#internetLabel p").hide()});
    $("#copyIcon").mouseover(function(){$("#copyLabel p").show()}).mouseout(function(){$("#copyLabel p").hide()});
    $("#textbookIcon").mouseover(function(){$("#textbookLabel p").show()}).mouseout(function(){$("#textbookLabel p").hide()});
    $("#otherIcon").mouseover(function(){$("#otherLabel p").show()}).mouseout(function(){$("#otherLabel p").hide()});
});
...
function send(){
    ...
    sentEval = true;
    // currently restricted from sending every 10 sec, this could easily be changed
    submitRecord(getUserValues()).then( function (callback){
        if(callback){
            $("#sendButton").hide();
            $("#textinput").hide();
            $("#nextButton").hide();
...
function changeLanguageCSS(language){
    //Makes chosen language in focus
...
function getUserValues(){
    ...
    var q1 = $("#sliderRate").slider("option", "value");
    var q2 = $("#sliderTime").slider("option", "value");
